import type { PhoneCountryOption } from "./types";

export const phoneCountryOptions = [
  { code: "+93", label: "Afghanistan (+93)" },
  { code: "+358", label: "Aland Islands (+358)" },
  ...
  { code: "+595", label: "Guyana (+595)" },
  { code: "+509", label: "Haiti (+509)" },
  { code: "+379", label: "Holy See (+379)" },
  ...
  { code: "+500", label: "South Georgia and South Sandwich Islands (+500)" },
...
export const phoneCountryCodeValues = [
  ...new Set(phoneCountryOptions.map((option) => option.code))
];
